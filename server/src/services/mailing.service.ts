...
class MailService {
  ...
  async sendWelcomeEmail(to: string, name: string) {
    ...
    const text = `Hi ${name}. \nWelcome to SnapURL. We are glad to have you.`;
    const html = `<strong>Hi ${name}. \nWelcome to SnapURL. We are glad to have you.</strong>`;
  ...
  async sendInviteEmail(to: string, name: string, inviteLink: string) {
    ...
    const text = `Hi ${name}. \nYou have been invited to SnapURL. Please use the following link to accept your invitation: ${inviteLink}`;
    const html = `<strong>Hi ${name}. \nYou have been invited to SnapURL.</strong> Please use the following link to accept your invitation: <a href="${inviteLink}">${inviteLink}</a>`;
